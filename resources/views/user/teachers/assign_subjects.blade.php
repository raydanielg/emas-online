...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('user.teachers.index') }}" class="btn btn-secondary btn-sm shadow-sm">
                        ...
                        <tbody>
                            @forelse($teachers as $teacher)
                                <tr>
                                    ...
                                    <td class="align-middle font-weight-bold">{{ $teacher->name }}</td>
                                    <td class="align-middle"><span class="badge badge-secondary">{{ $teacher->initials }}</span></td>
                                    ...
                                    <td class="text-right align-middle">
                                        <button type="button" class="btn btn-sm btn-primary shadow-sm" 
                                                onclick="openUnifiedAssignModal('{{ $teacher->id }}', '{{ $teacher->name }}')">
    ...
    <div class="modal fade" id="unifiedAssignModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content shadow-lg border-0">
                ...
                <form action="{{ route('user.subjects.teachers.assign') }}" method="POST">
                    @csrf
    ...
    <script>
        $(function () {
            ...
            $('#modalClassSelect').on('change', function() {
                ...
                $.get("{{ route('user.subjects.teachers.class_subjects') }}", { class_id: classId }, function(data) {
