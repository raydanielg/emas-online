<?php $__env->startSection('title', 'Import Classes'); ?>
...
<?php $__env->startSection('content_header'); ?>
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="<?php echo e(route('user.classes.index')); ?>" class="btn btn-secondary shadow-sm">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card card-outline card-success shadow-sm">
                ...
                <form action="<?php echo e(route('user.classes.assign.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <?php if($globalClasses->isEmpty()): ?>
                                ...
                                <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-md-6">
                                        <div class="list-group list-group-flush">
                                            <?php $__currentLoopData = $col; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="list-group-item d-flex align-items-center class-item">
                                                    <input type="checkbox" name="global_class_ids[]" value="<?php echo e($class->id); ?>" class="mr-3 class-checkbox">
                                                    <div class="flex-grow-1">
                                                        <div class="font-weight-bold text-dark"><?php echo e($class->name); ?></div>
                                                        <div class="small text-muted">Level: <?php echo e($class->level); ?></div>
                                                    </div>
                                                </label>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\ZERIXA\WebApps\emas\resources\views/user/classes/assign.blade.php ENDPATH**/ ?>