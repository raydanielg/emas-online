...
<?php $component->withAttributes([]); ?>
    <div class="min-h-screen relative overflow-hidden bg-gray-900">
        <div class="absolute inset-0 auth-bg auth-bg-1"></div>
        <div class="absolute inset-0 auth-bg auth-bg-2"></div>
        <div class="absolute inset-0" style="background: rgba(0,0,0,0.55);"></div>

        <div class="relative min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-2xl border-t-4 border-teal-600">
...
<?php endif; ?>
                    ...
                    <form class="mt-8 space-y-6" method="POST" action="<?php echo e(route('password.email')); ?>">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                ...
                <div class="text-center mt-6">
                    <a href="<?php echo e(route('login')); ?>" class="text-sm font-bold text-teal-600 hover:text-teal-800 transition duration-150">
        ...
        <style>
            ...
            .auth-bg-1 {
                background-image: url('<?php echo e(asset('PXL_20250502_075432413.RAW-01.COVER.jpg')); ?>');
                animation: authFade 14s ease-in-out infinite;
            }
            .auth-bg-2 {
                background-image: url('<?php echo e(asset('PXL_20250502_075446082.RAW-01.COVER.jpg')); ?>');
                opacity: 0;
                animation: authFade 14s ease-in-out infinite;
                animation-delay: 7s;
            }
...
<?php endif; ?>
<?php /**PATH E:\ZERIXA\WebApps\emas\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>