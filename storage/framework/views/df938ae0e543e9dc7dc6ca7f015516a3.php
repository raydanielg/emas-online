<?php $__env->startSection('title', 'School Levels'); ?>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-outline card-success shadow-sm">
                ...
                <form action="<?php echo e(route('schools.levels.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
            ...
            <div class="card card-outline card-success shadow-sm">
                <div class="card-header bg-warning d-flex justify-content-between align-items-center">
                    ...
                    <div class="card-tools">
                        <form action="<?php echo e(route('schools.levels.seed')); ?>" method="POST" style="display:inline;">
                            <?php echo csrf_field(); ?>
                    ...
                    <table class="table table-hover table-striped mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><span class="badge badge-info"><?php echo e($level->name); ?></span></td>
                                    <td><?php echo e($level->description ?? 'N/A'); ?></td>
                                    <td>
                                        <form action="<?php echo e(route('schools.levels.destroy', $level)); ?>" method="POST" style="display:inline;">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\ZERIXA\WebApps\emas\resources\views/admin/schools/levels/index.blade.php ENDPATH**/ ?>