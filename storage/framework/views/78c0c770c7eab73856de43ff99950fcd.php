<?php $__env->startSection('title', 'Resources & Teaching Materials'); ?>
...
<div class="container py-5">
    ...
    <div class="card border-0 shadow-sm rounded-xl mb-8">
        <div class="card-body p-4">
            <form action="<?php echo e(route('public.resources.index')); ?>" method="GET" class="row g-3 align-items-end">
                <div class="col-md-4">
    ...
    <div class="row">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div class="w-12 h-12 bg-teal-50 rounded-lg flex items-center justify-center">
                                ...
                                ?>
                                <i class="<?php echo e($icon); ?> text-teal-600 text-xl"></i>
                            </div>
                            <span class="badge badge-pill bg-teal-100 text-teal-700 px-3 py-1 small"><?php echo e($resource->type); ?></span>
                        </div>
                        <h5 class="font-bold text-gray-800 mb-2"><?php echo e($resource->title); ?></h5>
                        <p class="text-muted small mb-3">Subject: <span class="text-teal-700 font-semibold"><?php echo e($resource->subject->name); ?></span></p>
                        <p class="text-gray-500 small line-clamp-2 mb-4"><?php echo e($resource->description); ?></p>
                        <div class="d-flex gap-2">
                            <?php if($resource->file_path): ?>
                                <a href="#" class="btn btn-sm btn-teal flex-grow-1 rounded-lg">Download</a>
                            <?php endif; ?>
                            <?php if($resource->url): ?>
                                <a href="<?php echo e($resource->url); ?>" target="_blank" class="btn btn-sm btn-outline-teal flex-grow-1 rounded-lg">Open Link</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-12 text-center py-20 bg-white rounded-xl shadow-sm">
                ...
                <a href="<?php echo e(route('public.resources.index')); ?>" class="btn btn-sm btn-teal mt-2">View All Resources</a>
            </div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\ZERIXA\WebApps\emas\resources\views/public/resources/index.blade.php ENDPATH**/ ?>